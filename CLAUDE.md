# CLAUDE.md - AI Assistant Developer Guide for TrendRadar

> **Last Updated:** 2025-11-15
> **Version:** 3.0.5 (main crawler) / 1.0.1 (MCP server)

This document provides comprehensive guidance for AI assistants (like Claude) working with the TrendRadar codebase. It covers project structure, development workflows, conventions, and best practices.
...
2. **Explore configuration:**
   ...
   - Add keywords to `frequency_words.txt`
   - Test different report modes
...
3. **Code exploration:**
   - Read `main.py` structure
   - Understand crawler logic
   - Review notification code
